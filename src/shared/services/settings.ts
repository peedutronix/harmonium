...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      title: t('groups.google_search_console'),
      description:
        'custom your <a href="https://search.google.com/search-console" class="text-primary" target="_blank">Google Search Console</a> verification settings',
      tab: 'analytics',
    },
    {
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      placeholder:
        'Browser-based harmonium practice with keyboard shortcuts, touch controls, and SEO-friendly landing pages.',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      tab: 'analytics',
      tip: 'Paste the verification token from Google Search Console to output the required meta tag.',
    },
    {
